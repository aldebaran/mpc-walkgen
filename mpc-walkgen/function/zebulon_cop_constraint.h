...
#pragma once
#ifndef MPC_WALKGEN_FUNCTION_ZEBULON_COP_CONSTRAINT_H
#define MPC_WALKGEN_FUNCTION_ZEBULON_COP_CONSTRAINT_H
...
namespace MPCWalkgen
{
  ...
  public:
    CopConstraint(const LIPModel<Scalar>& lipModel, const BaseModel<Scalar>& baseModel);
    ~CopConstraint();
