...
function(gen_mpc_config)
  ...
  set(uproject MPC-WALKGEN)
  # Compute MPC-WALKGEN_DEPENDS
  set(_mpc_deps)
  if(WITH_LSSOL)
  ...
  # Generate a mpc-walkgen-config.cmake for qibuild, to be used in the worktree

  # Compute MPC-WALKGEN_LIBRARIES
  if(WIN32)
    set(_mpc_libs
  ...
  # Compute MPC-WALKGEN_INCLUDE_DIRS
  get_directory_property(_mpc_inc INCLUDE_DIRECTORIES)

  set(_code "# Autogenerated file. Do not edit.

set(MPC-WALKGEN_LIBRARIES \"${_mpc_libs}\" CACHE INTERNAL \"\" FORCE)
set(MPC-WALKGEN_INCLUDE_DIRS ${_mpc_inc} CACHE INTERNAL \"\" FORCE)
set(MPC-WALKGEN_DEPENDS ${_mpc_deps} CACHE INTERNAL \"\" FORCE)
set(MPC-WALKGEN_PACKAGE_FOUND TRUE CACHE INTERNAL \"\" FORCE)
"
)
  set(_mpc_config "${QI_SDK_DIR}/${QI_SDK_CMAKE_MODULES}/mpc-walkgen-config.cmake")
  file(WRITE ${_mpc_config} "${_code}")

  # Generate a mpc-walkgen-config.cmake for cmake, to be used once installed
  set(_code "# Autogenerated file. Do not edit.
...
set(${uproject}_INCLUDE_DIRS \"\${ROOT_DIR}/include;\" CACHE STRING \"\" FORCE)
mark_as_advanced(${uproject}_INCLUDE_DIRS)

find_library(${uproject}_LIBRARY mpc-walkgen)

set(${uproject}_LIBRARIES \${${uproject}_LIBRARY})
set(${uproject}_LIBRARIES \${${uproject}_LIBRARIES} CACHE INTERNAL \"\" FORCE)

include(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(${uproject} DEFAULT_MSG
  ${uproject}_LIBRARIES
  ${uproject}_INCLUDE_DIRS
)

set(${uproject}_PACKAGE_FOUND \${${uproject}_FOUND} CACHE INTERNAL \"\" FORCE)

set(${uproject}_DEPENDS ${_mpc_deps} CACHE INTERNAL \"\" FORCE)
")
  set(_mpc_config "${CMAKE_BINARY_DIR}/${QI_SDK_CMAKE_MODULES}/sdk/mpc-walkgen-config.cmake")
  file(WRITE ${_mpc_config} "${_code}")
  install(FILES ${_mpc_config} DESTINATION "/share/cmake/mpc-walkgen")
endfunction()
