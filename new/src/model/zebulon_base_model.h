...
namespace MPCWalkgen
{
  ...
  public:
    ...
    {assert(velocityLimit>=0);velocityLimit_=velocityLimit;}
    ...
    {assert(accelerationLimit>=0);accelerationLimit_=accelerationLimit;}
    ...
    {assert(jerkLimit>=0);jerkLimit_=jerkLimit;}
    ...
    {assert(supportHull.p.size()>=3);supportHull_=supportHull;}
