...
namespace MPCWalkgen{
  ...
  /// \brief compute the value of the polynomial of degree 3 p(x)
  inline double p(const Eigen::Matrix<double,4,1> & factor, double x);

  /// \brief compute the value of the derivative of the polynomial of degree 3 p(x)
  inline double dp(const Eigen::Matrix<double,4,1> & factor, double x);

  /// \brief compute the value of the second derivative of the polynomial of degree 3 p(x)
  inline double ddp(const Eigen::Matrix<double,4,1> & factor, double x);
